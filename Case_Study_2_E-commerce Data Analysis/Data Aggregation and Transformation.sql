...
o	Use SUM() to calculate the total revenue generated by each product category.
o	Include the number of orders per category as well.
*/
...
o	Create a report showing total sales for each month.
o	Use the DATE_FORMAT() function to group sales by month and year.
*/
SELECT  
